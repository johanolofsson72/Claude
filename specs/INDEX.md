...
- [ ] 008 — scenarios-map-canary-unheeded — spec-only — five maps over the 25 KB canary: consultpilot 682 KB (27x), agentcrm 252, rocky 242, film-i-vast 137, fundit 30. rocky and msroute are split; the rest are one file, read whole every spec. Diagnos: `specs/INDEX.pending.md`
