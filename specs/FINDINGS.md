...
- [ ] F008 — defect — 2026-09-23 — From ighweld F369 (2026-09-23): spec-kit's .specify/templates/spec-template.md numbers Success Criteria SC-001.. under the scenario map's prefix, re-introducing the F011 collision in every new spec (ighweld 198 had to rename all of them NNN-SCnnn). Have speckit-extension-policy.sh rewrite the template after specify init, or letter them SC-A. Related to row 048.
